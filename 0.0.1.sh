...
installArchiSteamFarm(){
	...
	wget https://github.com/JustArchiNET/ArchiSteamFarm/releases/download/3.4.0.7/ASF-linux-x64.zip -O ASF-linux-x64.zip
...
configArchiSteamFarm(){
    ...
    "\"AutoSteamSaleEvent\"":true
		...
		#加入Steamcommunity的IP
		chmod 777 /etc/hosts
		echo -e "#23.74.17.124 store.steampowered.com
#23.74.17.124 steamcommunity.com" > /etc/hosts
		echo "挂卡账户配置成功！"
	fi 
} 
...
${green}sudo screen -U -S ASF        ${none}
